...
| --------------------------------------------------------------- | --------------------------------------------------------------- | ------------ | ---------- | ---------------- | ------------------------------------------------------------------------------------------------------------- |
| [Bubble Sort](https://www.geeksforgeeks.org/bubble-sort/)       | O(n)                                                            | O(n^2)       | O(n^2)     | O(1)             | [See bubble sort implementation](./package/algorithms/sorting-algorithms/bubble-sort/bubble-sort.js)          |
| [Insertion Sort](https://www.geeksforgeeks.org/insertion-sort/) | O(n)                                                            | O(n^2)       | O(n^2)     | O(1)             | [See insertion sort implementation](./package/algorithms/sorting-algorithms/insertion-sort/insertion-sort.js) |
| [Selection Sort](https://www.geeksforgeeks.org/selection-sort/) | O(n^2)                                                          | O(n^2)       | O(n^2)     | O(1)             | [See selection sort implementation](./package/algorithms/sorting-algorithms/selection-sort/selection-sort.js) |
| [Merge Sort](https://www.geeksforgeeks.org/merge-sort/)         | O(n log n)                                                      | O(n log n)   | O(n log n) | O(n)             | [See merge sort implementation](./package/algorithms/sorting-algorithms/merge-sort/merge-sort.js)             |
| [Quick Sort](https://www.geeksforgeeks.org/quick-sort/)         | O(n log n)                                                      | O(n log n)   | O(n^2)     | O(log n)         | [See quick sort implementation](./package/algorithms/sorting-algorithms/quick-sort/quick-sort.js)             |
| [Radix Sort](https://www.geeksforgeeks.org/radix-sort/)         | O(nk) (n - length of the array, k - number of digits (average)) | O(nk)        | O(nk)      | O(n + k)         | [See radix sort implementation](./package/algorithms/sorting-algorithms/radix-sort/radix-sort.js)             |
...
- [See the implementation of Singly Linked List](./package/data-structures/linked-lists/singly-linked-list/singly-linked-list.js)
...
- [See the implementation of Doubly Linked List](./package/data-structures/linked-lists/doubly-linked-list/doubly-linked-list.js)
...
- [See the implementation of Stack](./package/data-structures/stack/stack.js)
...
- [See the implementation of Queue](./package/data-structures/queues/queue.js)
...
- [See the implementation of BST](./package/algorithms/binary-search-trees/binary-search-tree.js)
...
- [See the implementation of BFS](./package/algorithms/binary-search-trees/binary-search-tree.js)
...
- [See the implementation of DFS](./package/algorithms/binary-search-trees/binary-search-tree.js)
...
- [See the implementation of Max Binary Heap](./package/algorithms/binary-heap/max-binary-heap.js)
...
- [See the implementation of Min Binary Heap](./package/algorithms/binary-heap/max-binary-heap.js)
...
- [See the implementation of Priority Queue](./package/algorithms/binary-heap/priority-queue.js)
...
- [See the implementation of Hash Tables](./package/algorithms/hash-tables/hash-tables.js)
...
- [See the implementation of Graphs](./package/algorithms/graphs/graphs.js)
...
- [See the implementation of Dijkastra's Algorithm](./package/algorithms/dijkstra's-algorithm/dijkastras-algorithm.js)
...
- [See the implementation of Dynamic Programming - Fibonacci Example](./package/algorithms/dynamic-programming/fibonacci.js)
...
- [See the implementation of Memoization - Fibonacci Example](./package/algorithms/dynamic-programming/fibonacci.js)
...
- [See the implementation of Tabulation - Fibonacci Example](./package/algorithms/dynamic-programming/fibonacci.js)
